...
\section{Conclusion}
The LiteCrypto library is available at \href{https://github.com/WardenGnaw/LiteCrypto}{https://github.com/WardenGnaw/LiteCrypto}. It is available for anyone to use and modify. After further testing with CubeSat, LiteCrypto will hopefully be integrated for use.
